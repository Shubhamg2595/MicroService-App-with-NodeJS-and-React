...
app.post("/events", (req, res) => {
  ...
  axios.post("http://comments-srv:3001/events", event); //coomments
  axios.post("http://query-srv:3003/events", event); //query
  // adding comment creation event for moderation service
  axios.post("http://moderation-srv:3004/events", event); //moderate service
